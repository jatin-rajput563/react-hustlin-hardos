...
import dotImg from "../assets/images/svg/roadmap-sign.svg";
import lineImg from "../assets/images/png/roadmap-line.png";
const Roadmap = () => {
  return (
    <>
      <div id="roadmap">
        <div className="max-w-[1140px] px-3 xl:px-0.5 mx-auto py-10 sm:py-14 md:py-18 lg:py-[88.5px]">
